...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <a href="{{url('customer.index')}}" class="btn btn-success btn-sm" style="color: #fff">Danh sách nhân viên</a>
        </ol>
    </section>
    <!-- Main content -->
    @php
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                ...
                @endisset
                <!-- form start -->
                    <form role="form" action="{{url('customer.update',['id'=>$customer->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="content-image-upload" style="overflow:hidden ;width: 70px ; height: 70px;border-radius: 5px ; border: 1px solid; margin-top: 10px;">
                                    <img id="image-upload" src="{{$customer->image}}" width="100%" height="100%"  alt="">
                                </div>
                            </div>
                            <div>
                                <label>
                                    <input type="checkbox" name="active"
                                           value="1" {{$customer->active?'checked':''}} {{isset($old['active']) ? 'checked' : ''}}> Kích hoạt
                                </label>
                            </div>
                        </div><!-- /.box-body -->
