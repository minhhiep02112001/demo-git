...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <a href="{{url('customer.create')}}" class="btn btn-success btn-sm" style="color: #fff">Thêm nhân viên</a>
        </ol>
    </section>
    <!-- Main content -->
                            ...
                            @if(count($customer) > 0)
                                @foreach($customer as $key=>$item)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning btn-xs" href="{{url('customer.edit' ,['id' => $item->id])}}">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-xs btn-sm btn-danger btn-delete" data-id="{{ $item->id }}" data-model="customer">
